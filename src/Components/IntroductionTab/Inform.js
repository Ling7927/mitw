...
export const Inform =[
    ...
    {id:"2" ,Tabtitle:"聯測松機制",icon:<GiTargetDummy/>,content:<div style={{padding:"2rem 5rem",display:"flex",flexDirection:"column"
        ...
        <ul style={{margin:0,padding:0}}>
            ...
            <li>聯測目的在於針對依循指定規格開發的系統進行互通性驗證，參加聯測之前可事先使用開源工具或是開發的系統跟產品準備與測試。聯測提供一個有結構且嚴謹的驗證環境，讓參加者一起測試其彼此產品的互通性，並且可透過標準技術框架讓產品以實施或發佈的方式進行測試。</li>
            <li>參加聯測的單位可測試產品是否實現標準規範，並與其他公司用實際使用情境進行測試。透過廠商之間緊密合作解決彼此的問題，可以快速排除不同系統之間整合與界接的技術問題。</li>
            <li>聯測期間，參與者與其他系統進行連線測試，用來驗證開發的產品與系統符合國際標準規範，在聯測時如果遇到問題亦可在短時間內修正不符合格的項目。聯測活動使用測試工具來驗證數萬筆交易紀錄，且由中立的「連測督察員(Monitor)」來評斷結果。</li>
            <li>連測結束後，可透過連測結果陣列(Connectathon Results Matrix)查看。透過連測活動來達到產業之間的數據交換與互助，以合作的方式相互發展具備全球市場競爭力之產品。<img src={p3} style={{width:"95%"}} /> <br/>促使健康保健IT產業(healthcare IT) 的使用者以及廠商能夠共同合作達到IT系統互通(interoperability)，可透過以下方式達成</li>
            ...
            <li>從2020年開始，從四大領域擴展到多個領域，截至今天為止，共涵蓋10領域，讓不同廠商開發的系統能夠互通。</li>
            <li>透過照護提供者（Care providers）與IT從業人員以及廠商共同合作(Coordinate) 制定標準(Standards)與共通指引（common guidelines ）以達到彼此需求，照護提供者提供臨床上面臨的實際問題，IT從業人員與廠商根據需求來發展符合標準的解決方案，根據共通的指引來購買這些符合規範。</li>
        </ul>
    </div>},
   ...
   {id:"3" ,Tabtitle:"關係人效益",icon:<BsLink/>,content:
    <div style={{padding:"2rem 5rem"}}>
        ...
        <ul>
            ...
            <li>由合格的測試專家(工具、督察員)進行獨立的產品測試，並且經過驗證的測試工具可確保產品質量並降低實施成本</li>
        ...
        <ul>
            ...
            <li>參加者可選擇感興趣的賽道(Track)，並動手實作開發，且可直接與其他開發者進行深度的合作與交流。</li>
        ...
        <ul>
            <li>改善只「訂」標準做法
                <ul>
                    <li style={{listStyle:"circle"}}>醫院為了符合衛福部規定，僅要求廠商在輸出格式符合規範，作為電子病歷歸檔之用。</li>
                    <li style={{listStyle:"circle"}}>各醫院僅完成規定的電子病歷，但對於系統之間的「互通性」並未加以驗證，無法確定每一家醫院或是廠商作的系統是否能彼此間互通。</li>
                </ul>
            </li>
            <li>以「做」標準的方式透過實作快速的驗證醫院及廠商所開發的電子病歷是否真的能互通</li>
