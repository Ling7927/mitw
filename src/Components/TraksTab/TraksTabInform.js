...
export const TraksTabInform=[
    {Id:"1" ,TabTitle:"#01",ContentTitle:"TRACK#1 - 病人基本資料",Img:[{"img":T1_1},{"img":T1_2},{"img":T1_3},{"img":T1_4}],List:[{"id":"1","Sc":"Scenario 1 病人身分確認用"}, {"id":"2","Sc":"Scenario 2 聯繫病人用 "},{"id":"3","Sc":"Scenario 3：院外系統 "},{"id":"4","Sc":"Scenario 4 (2022已移除，整併進Track #7緊急醫療救護) "}],Sc1:<div><img src={logo}/></div>,},
