...
const IndustryInform = [
  ...
  },
  {
    ...
    //     長庚醫科U-Dr遠距醫療產品特色：
    //     <ol>
    //       <li>提供一般門診可支援多點連線遠距會診服務應用。\n</li>
    //       <li>多元醫儀IoT設備介接服務。\n</li>
    //       <li>即時雙通道影音傳輸進行視訊診察應用，醫病親臨互動。\n</li>
    //       <li>整合介接各家HIS醫囑系統與遠距會診服務。\n</li>
    //     </ol>
    //     醫療服務面特色優勢：
    //     <ol>
    //       <li>
  ...
  },
  {
    ...
    //       超音波、心電圖、五官鏡、二次截像、儀器工作清單、DICOM顯示、儲存與傳輸。\nDICOM去識別化等服務，可針對高度客製化，滿足使用者需求。\n
    //     </li>
    //     <li>
    //       HL7 FHIR技術整合服務:
    //       提供臨床資料轉換FHIR格式服務，包含CDA、臨床資料庫等。\n可針對客戶設計FHIR
...
const HospitalInform = [
  {
    ...
    tracks:
      "參加賽道 \n TRACK#1 - 病人基本資料互通 \n TRACK#2 - 生理量測數據互通 \n TRACK#3 - 用藥及疫苗接種紀錄",
    introduce:
      "本計畫以花蓮縣秀林鄉、吉安鄉、鳳林鎮、光復、萬榮、卓溪鄉及台東縣海端鄉、池上鄉、延平鄉為健康福祉科技整合照護之示範推動地區，透過對示範場域健康及醫療照護現況與需求進行全面調查與分析，以衛生所醫療資訊系統為基礎，整合慈濟醫院醫療資訊系統的門急診、手術住院、慢性病及藥物資訊，盤整示範場域目前之系統使用狀態，並以家庭歸戶進行跨系統介接，建置家庭健康戶口名簿，開發「健康福祉科技整合照護平台」。\n 平台包括以鄉鎮為範圍的：\n1.家戶歸戶作業；2.預防保健(四癌篩檢、X光、預防注射)名冊匯入及查詢列印；3.慢性病(糖尿病、高血壓、高血脂、肝病、胃病、COPD)的資料匯入及個案管理；4.長照據點(社區關懷據點及部落文化健康站)個案管理及生理量測系統；5.居家端個案收案及設備綁定管理，6.健康福祉FHIR跨區域互通系統；7.健康福祉視覺化地理資訊系統；8.健康福祉Line Bot主動推播及整合查詢系統。\n 另透過 FHIR Gateway介接：\n1.健康福祉科技整合照護平台；2.各家雲端生理量測平台; 3.醫院及衛生所HIS；4.縣政府社會處早療及獨居長者個案管理系統；5.醫院罕病兒童個案管理系統；6.急性後期及長照轉介。\n計畫應用遠距資通訊科技發展適合偏鄉的遠距照護及醫療服務模式。\n",
  },
];
